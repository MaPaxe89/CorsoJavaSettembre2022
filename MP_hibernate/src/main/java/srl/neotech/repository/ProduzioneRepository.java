...
public interface ProduzioneRepository extends JpaRepository<ProductionCompany,Integer>{
	
	@Query( value="SELECT production_company.company_name, movie.title ,movie.budget\n"
